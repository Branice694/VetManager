...

							 {
                                 if($row_request_appointement->status=="accept")
                                 {
                                     echo '
                                       ...
                                       <table id="mainStatsTable">
                                                       <tr>Date : '.$row_request_appointement->day.'</tr> 
                                                        <tr>Time :'.$row_request_appointement->time.'</tr>
                                                        <tr>Pet nama :'.$row_request_appointement->pet.'</tr>
                                                        <tr>Service:'.$row_request_appointement->service.'</tr>
                                                        </table>
                                                    </ul>
                                                    </details>
